...
import lk.ijse.gdse.factory_mvc_project.dto.tm.MachineTm;
import lk.ijse.gdse.factory_mvc_project.model.EmployeeModel;
import lk.ijse.gdse.factory_mvc_project.model.MachineModel;
...
public class MachinesController implements Initializable {
    ...
    void addOnAction(ActionEvent event){
        try {
            ...
            MachineDto machineDto = new MachineDto(machineId,
                    machineName,
                    machineTask,
                    machineQuantity,
                    employeeId
    ...
    private void loadTableData(){
        try {
            ArrayList<MachineDto> machineDtos = machineModel.getAllMachine();
    ...
    void cmbEmployeeOnAction(ActionEvent event){
        try {
            ...
            EmployeeDto employeeDto = employeeModel.findByContactNumber(selectedEmployee);
