...
public class EmployeeController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
      idColomn.setCellValueFactory(new PropertyValueFactory<>("employeeId"));
        ...
        taskColomn.setCellValueFactory(new PropertyValueFactory<>("employeeTask"));
...
//            loadTableData();
    ...
    @FXML
    void tblEmployeeOnMouseClicked(MouseEvent event) throws SQLException, ClassNotFoundException {
